...
class SignupForm(forms.ModelForm):
    ...
    def clean(self):
        cleaned=super().clean(); p1=cleaned.get('password1'); p2=cleaned.get('password2')
        if p1 and p1!=p2: raise forms.ValidationError('Passwords do not match.'); return cleaned
